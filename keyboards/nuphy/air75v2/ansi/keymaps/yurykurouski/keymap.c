...
[0] = LAYOUT_ansi_84(
	...
	TD(TD_SHIFT_CAPS),	KC_A,   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	 						KC_ENT,		KC_HOME,
...
[1] = LAYOUT_ansi_84(
	...
	QK_BOOT, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______, 	_______,	            _______,
...
combo_t key_combos[] = {
    COMBO(backspace_two_press_combo, KC_BSPC),
    COMBO(enter_two_press_combo, KC_ENT),
};
